...
When deployed to production, frontend requests should use the relative path `/api` and should not point to `localhost`.
...
- `VITE_APP_DOMAIN=https://www.smacom.co.ke`

**Note:** In production, use relative API routing and avoid any `localhost` hosts or redirects.
