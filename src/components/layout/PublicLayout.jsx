...
const links = [
  ...
  { to: '/learning', label: 'Platform' },
  { to: '/impact', label: 'Impact' },
  { to: '/contact#partnerships', label: 'Partners' },
        ...
        <div className="mx-auto flex h-[88px] max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          <Link to="/" className="flex shrink-0 items-center gap-3" aria-label="SMACOM Solutions home">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-[11px] text-muted-foreground uppercase tracking-[0.16em]">Circular Organic Infrastructure</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <>
                <Link to="/dashboard" className="hidden items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground transition hover:bg-accent sm:inline-flex">Open Dashboard <ArrowRight className="h-4 w-4" /></Link>
                <button className="inline-flex h-12 w-12 items-center justify-center rounded-lg border border-border bg-background text-foreground transition hover:bg-accent md:hidden" aria-label={mobileOpen ? 'Close navigation' : 'Open navigation'} aria-expanded={mobileOpen} onClick={() => setMobileOpen(!mobileOpen)}>
              ...
              <>
                ...
                <Link to="/contact" className="register-link inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-[15px] font-semibold text-primary-foreground transition duration-200 hover:bg-primary/90">
          ...
          <div className="border-t border-border/70 bg-background md:hidden">
            <nav className="mx-auto flex max-w-7xl flex-col px-6 py-4">
              ...
              <div className="mt-4 grid gap-2 border-t border-border/70 pt-4">
                <Link to="/contact" className="mobile-register flex min-h-12 items-center justify-center rounded-lg bg-primary px-4 py-3 text-center text-[15px] font-semibold text-primary-foreground transition hover:bg-primary/90">
                  Request a demo
                </Link>
                <Link to="/login" className="mobile-login flex min-h-12 items-center justify-center rounded-lg border border-border px-4 py-3 text-center text-[15px] font-semibold text-[#374151] transition hover:text-primary">
                  Login
                </Link>
              </div>
            </nav>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-[1.8fr_1fr_1fr_1.4fr] lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-xl text-sm leading-7 text-slate-400">
              Digital infrastructure connecting organic waste producers, processors and farmers.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li><Link to="/learning" className="transition hover:text-white">Platform</Link></li>
              <li><Link to="/contact#partnerships" className="transition hover:text-white">Partners</Link></li>
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-6 py-6 text-sm text-slate-400 lg:px-8">
            ...
            <div className="flex gap-6">
              <span>Privacy and terms available on request</span>
            </div>
          </div>
        </div>
      </footer>
