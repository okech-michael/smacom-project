  ...
  return (
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-[40px] bg-forest text-white p-12 md:p-20 text-center">
          ...
          <div className="relative">
            ...
            <p className="mt-5 text-white/70 text-lg max-w-2xl mx-auto text-pretty">
              Whether you produce waste, process it, or grow with it, SMACOM
              gives you the platform, tools, and network to scale your impact.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-spring text-forest-deep font-bold rounded-2xl hover:scale-[1.02] transition-transform shadow-xl shadow-spring/20"
              >
                Request a Demo
              </a>
              <a
