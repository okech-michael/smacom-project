...
export const Route = createFileRoute("/solutions")({
  head: () => ({
    meta: [
      { title: "Solutions | SMACOM Solutions" },
      {
        name: "description",
        content:
          "Explore the SMACOM solution stack: smart waste collection, bio-processing, circular economy tools, IoT monitoring, and digital waste tracking.",
      },
      { property: "og:title", content: "SMACOM Solutions Portfolio" },
      {
        property: "og:description",
        content:
          "End-to-end circular waste solutions for cities, businesses, and farms.",
      },
    ],
  }),
  component: Solutions,
...
const SOLUTIONS = [
  {
    ...
    business:
      "Reduce landfill fees by up to 60% while unlocking new revenue from certified organic outputs.",
    environment:
      "Diverts high-methane organics from landfills and delivers them to productive bio-processing.",
  ...
  },
  {
    ...
    business:
      "Turnkey infrastructure design plus SMACOM-OS operations software delivers faster payback on processing capex.",
    environment:
      "Aerobic and anaerobic pathways prevent methane emissions and rebuild soil organic matter.",
  ...
  },
  {
    ...
    environment:
      "Every kilogram tracked, every claim verifiable &mdash; no leakage, no greenwashing.",
  ...
  },
  {
    ...
    business:
      "Reliable, high-margin product line for processors, with SMACOM handling logistics and quality assurance.",
    environment:
      "Substitutes synthetic nitrogen inputs, restoring soil biology and reducing agricultural emissions.",
  ...
  },
  {
    ...
    business:
      "Diversify processing revenue and give feed buyers a lower-cost, traceable alternative.",
    environment:
      "Cuts reliance on imported feed protein and reduces the emissions footprint of animal agriculture.",
  ...
  },
  {
    ...
    business:
      "Meet regulatory obligations effortlessly with automated reports and audit-ready evidence.",
    environment:
      "Early detection of pollution risks and quantified environmental co-benefits from every intervention.",
  ...
  },
  {
    ...
    business:
      "Convert environmental performance into a fundable, defensible revenue stream.",
    environment:
      "Independently verified emissions reductions and removals with a full public data trail.",
          ...
          {SOLUTIONS.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="lg:col-span-6 [direction:ltr]">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-spring/10 text-forest text-[11px] font-bold uppercase tracking-widest mb-5">
                    <Icon size={14} /> {s.tag}
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-900 font-display leading-tight text-balance">
                    {s.title}
                  </h2>
                  ...
                  <div className="mt-8 grid sm:grid-cols-2 gap-4">
                    <div className="p-5 rounded-2xl bg-slate-50 ring-1 ring-slate-200">
                      ...
                      <p
                        ...
                        dangerouslySetInnerHTML={{ __html: s.business }}
                      />
                    </div>
                    <div className="p-5 rounded-2xl bg-spring-soft/40 ring-1 ring-spring/20">
                      <div className="text-[11px] font-bold uppercase tracking-widest text-forest">
                        Environmental impact
                      </div>
                      <p
                        className="mt-2 text-sm text-slate-700 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: s.environment }}
                      />
                    </div>
                  </div>
